...
def project_token_groups(tokens, projection, group_size=4):
    """Flatten adjacent token groups and apply a shared projection."""
...
class DiT(nn.Module):
    ...
    def __init__(
        ...
        self.x2_group_projection = nn.Linear(4 * hidden_size, hidden_size)
    ...
    def forward(self, x, t, y):
        ...
        x2 = project_token_groups(x2, self.x2_group_projection, group_size=4)
        # shape of x2 and x
